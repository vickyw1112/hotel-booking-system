...
public class HotelSystem {
	 ...
	 * @return
	 */
	public Pair availableRoom(LocalDate date, int nights, LinkedList<Integer> capicity, LinkedList<Integer> numBookings) {
		LinkedList<Room> rooms;
		for(Hotel hotel: this.hotels) {
			if((rooms = hotel.searchAvailabeRooms(date, nights, capicity, numBookings)) != null) {
	 ...
	 * @return
	 */
	public Pair changeBooking(LocalDate date, int nights, LinkedList<Integer> capicity, LinkedList<Integer> numBookings, String name) {
